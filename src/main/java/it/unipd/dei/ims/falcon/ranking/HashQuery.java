 ...
 * This query is a modified version of a {@link org.apache.lucene.search.TermQuery}
 * Different HashQuery's can be combined in a {@link SegmentQuery}.
 */
public class HashQuery extends Query {
	...
	private class HashWeight extends Weight {
		...
		HashWeight(final Searcher searcher, final int qtf) {
		...
		@Override
		public Explanation explain(IndexReader reader, int i) {
	...
	HashQuery(Term t, int tf, int querySegmentLength, float docsSegmentNorm) {
		term = t;
		qtf = tf;
